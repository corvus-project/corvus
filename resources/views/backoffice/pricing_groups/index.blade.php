...
@section('title', config('corvus.app_name') . ' | ' . __('labels.pricing_groups.title'))
        ...
        <table class="table table-light table-hover table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $group->slug }}</td>
                    <td>
                        <a href="{{ route('backoffice.pricing_groups.delete', $group->id) }}"
                            class="btn btn-danger btn-xs ml-1 float-right" title="Delete the group"><i
                                class="fas fa-trash"></i></a>
                        <a href="{{ route('backoffice.pricing_groups.edit', $group->id) }}"
