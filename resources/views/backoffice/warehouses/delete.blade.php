    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="btn-toolbar float-right" role="toolbar" aria-label="">
                            <a href="{{ route('backoffice.warehouses.create') }}" class="btn btn-success btn-xs m-1"
                ...
                <form autocomplete="off" role="form" action="{{ route('backoffice.warehouses.destroy', $warehouse->id) }}"
                    method="post">
