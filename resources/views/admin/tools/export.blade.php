    ...
    <div class="card-body">
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                <div class="row">
                    <div class="col">
                        <form autocomplete="off" role="form" action="{{ route('admin.tools.exports.product_list') }}"
                            method="post">
            ...
            <div class="tab-pane fade" id="nav-price-list" role="tabpanel" aria-labelledby="nav-price-list-tab">
                ...
                <div class="row">
                    <div class="col">
                        <form autocomplete="off" role="form" action="{{ route('admin.tools.exports.price_list') }}"
                            method="post">
                            <input type="hidden" name="_token" value="{{{ csrf_token() }}}" />
