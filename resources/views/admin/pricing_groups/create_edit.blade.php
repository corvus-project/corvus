        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="col-sm-12">
                        <div class="btn-toolbar float-right" role="toolbar" aria-label="">
                            <a href="{{ route('admin.pricing_groups.create') }}" class="btn btn-success btn-sm m-1"
                                ...
                                <a href="{{ route('admin.pricing_groups.index') }}" class="btn btn-success btn-sm m-1"
                ...
                <form autocomplete="off" role="form"
                    action="{{ (isset($group)) ? route('admin.pricing_groups.update', $group->id) : route('admin.pricing_groups.store') }}"
                    method="post">
