                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="btn-toolbar float-right" role="toolbar" aria-label="">
                            <a href="{{ route('admin.groups.create') }}" class="btn btn-success btn-sm m-1"
                                data-toggle="tooltip" title="Create a group"><i class="fas fa-plus"></i></a>
                            <a href="{{ route('admin.groups.index') }}" class="btn btn-success btn-sm m-1"
                                data-toggle="tooltip" title="List the groups"><i class="fas fa-list"></i></a>
                        </div>
                    </div>
                </div>

                <form autocomplete="off" role="form" action="{{ route('admin.groups.destroy', $group->id) }}"
                    method="post">
