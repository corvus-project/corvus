                    ...
                    <div class="col-sm-12">
                        <div class="btn-toolbar float-right" role="toolbar" aria-label="">
                            ...
                            <a href="{{ route('admin.products.view_stocks', $product->id) }}"
                                ...
                                title="List the stocks"><i class="fas fa-list"></i></a>
                        </div>
                    </div>
                </div>

                <form autocomplete="off" role="form"
                    action="{{ route('admin.products.delete_stock.destroy', [$stock->product_id, $stock->id]) }}"
                    method="post">
                    ...
                    <div class="form-group row {!! $errors->first('from_date', 'has-warning') !!}">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input class="form-control" id="from_date" name="from_date" autocomplete="off"
                                value="{{{ old('from_date', isset($stock) ? $stock->from_date->format('Y-m-d') : null) }}}" readonly> {!!
                    ...
                    <div class="form-group row {!! $errors->first('to_date', 'has-warning') !!}">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" id="to_date" name="to_date" autocomplete="off" readonly="readonly"
                                value="{{{ old('to_date', isset($stock) ? $stock->to_date->format('Y-m-d') : null) }}}"> {!!
