    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form autocomplete="off" role="form" action="{{ route('admin.stock_types.destroy', $stock_type->id) }}"
                    method="post">
                    ...
                    <div class="form-group {!! $errors->first('name', 'has-warning') !!}">
                        ...
                        <input type="text" class="form-control" id="name" name="name" autocomplete="off"
                            value="{{{ old('name', isset($stock_type) ? $stock_type->name : null) }}}" readonly> {!!
                        $errors->first('name', '<span class="help-block">:message</span>') !!}
                    </div>

                    <div class="form-group">

                        <p>{{ trans_choice('labels.stock_types.stocks_count_definitions', $stock_type->stocks()->count()) }}</p>
                    </div>
