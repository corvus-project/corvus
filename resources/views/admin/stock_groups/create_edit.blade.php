        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="btn-toolbar float-right" role="toolbar" aria-label="">
                            <a href="{{ route('admin.stock_groups.index') }}" class="btn btn-success btn-sm m-1"
                                data-toggle="tooltip" title="List the stock_groups"><i class="fas fa-list"></i></a>
                            <a href="{{ route('admin.stock_groups.create') }}" class="btn btn-info btn-sm m-1"
                ...
                <form autocomplete="off" role="form"
                    action="{{ (isset($stock_group)) ? route('admin.stock_groups.update', $stock_group->id) : route('admin.stock_groups.store') }}"
                    method="post">
